...
const devServerUrl = `http://${devServer.host}:${devServer.port}/${paths.public_url_dir}/${paths.entry}/`
const publicUrl = ifHasCDN ? `${env.ASSET_HOST}/${paths.entry}/` : `/${paths.public_url_dir}/${paths.entry}/`
