...
VCR.configure do |c|
  ...
  c.ignore_request do |request|
    !(request.uri.starts_with?(CALS_API_URL) || request.uri.starts_with?(AUTHENTICATION_API_BASE_URL) || request.uri.starts_with?(GEO_SERVICE_URL) || request.uri.starts_with?(BASE_SEARCH_API_URL))
  end
