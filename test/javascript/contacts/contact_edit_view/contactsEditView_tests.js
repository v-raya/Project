...
describe('contacts edit view ', () => {
  ...
  it('tests saveProgress', () => {
    let saveProgressBtn = component.find('#contactsSave')
  ...
  it('tests saveProgress with Id', () => {
    let saveProgressBtn = componentWithContact.find('#contactsSave')
    saveProgressBtn.simulate('click')
  ...
  it('tests cancel', () => {
    let cancelBtn = component.find('#contactsCancel')
  ...
  it('verify date', () => {
    let dateOfContactField = component.find('input#dateOfContact')
  ...
  it('verify contact method change', () => {
    let contactField = component.find('select#methodOfContact.reusable-select')
  ...
  it('verify contact classification true change', () => {
    let classificationField = component.find('input#contactClassificationtrue')
  ...
  it('verify contact classification false change', () => {
    let classificationField = component.find('input#contactClassificationfalse')
  ...
  it('verify contact title', () => {
    let dateOfBirthField = component.find('input#contactTitle')
  ...
  it('verify contact notes', () => {
    let dateOfBirthField = component.find('#contactNotes').hostNodes()
