...
describe('in person data tests ', () => {
  let component
  const setInPersonDataSpy = jasmine.createSpy('setInPersonData')
  ...
  it('verify contact type change', () => {
    const contactTypeField = component.find('#contactType').hostNodes()
  ...
  it('verify contact notice change', () => {
    const noticeField = component.find('#contactNoticetrue').hostNodes()
  ...
  it('verify contact collateral visit change', () => {
    const collateralVisitField = component.find('#collateralVisittrue').hostNodes()
  ...
  it('onChange event on start time', () => {
    const applicantDetails = component.find('#startTime').hostNodes()
  ...
  it('onChange event on end time', () => {
    const applicantDetails = component.find('#endTime').hostNodes()
    applicantDetails.simulate('change', {target: {value: '232020'}})
