...
describe('Verify MinorCardFields', () => {
  ...
  const relationType = relationshipTypes
  beforeEach(() => {
  ...
  it('verify Relationship field', () => {
    const relationShipField = minorChildCardComp.find('.col-md-12').find('#relationship_to_applicant0child0relationship_to_applicant_freeform').hostNodes()
  ...
  it('verify Gender', () => {
    const relationShipField = minorChildCardComp.find('.col-md-12').last().find('#minor_gender').hostNodes()
  ...
  it('verify date of birth', () => {
    const dateOfBirthField = minorChildCardComp.find('.col-md-12').last().find('#date_of_birth').hostNodes()
  ...
  describe('#YesNoRadioComponent', () => {
    ...
    it('verify child_financially_supported field', () => {
      const relationShipField = minorChildCardComp.find('input[type="radio"]').at(0)
    ...
    it('verify child adopted field', () => {
      const relationShipField = minorChildCardComp.find('input[type="radio"]').at(2)
      relationShipField.simulate('change', {target: {value: true}})
  ...
  describe('componentWillUnmount test', () => {
    ...
    it('expects the component to unmount', () => {
      const instance = minorChildCardComp.instance()
