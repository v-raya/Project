...
describe('RFA 02 Out of State Registry check card test', () => {
  ...
  it('handleRegistryClear', () => {
    const outOfStateRegistryCleared0trueField = outOfStateRegistryCheckWithProps.find('#person0outOfStateRegistryCleared0true').hostNodes()
  ...
  it('handleRegistryClear change Date Field', () => {
    const outOfStateRegistrydate0Field = outOfStateRegistryCheckWithProps.find('#person0outOfStateRegistry0dateEdit0').hostNodes()
  ...
  it('handleRegistryClear change TextArea Field', () => {
    const outOfStateRegistrynotes0Field = outOfStateRegistryCheckWithProps.find('#person0outOfStateRegistry0textAreaEdit0').hostNodes()
  ...
  it('handleRequestInfo method with checkbox change', () => {
    const outOfStateRegistry0checkboxEdit0Field = outOfStateRegistryCheckWithProps.find('#person0outOfStateRegistry0checkboxEdit0').hostNodes()
  ...
  it('handleOutOfStateRegistry', () => {
    const outOfStateRegistry0trueField = outOfStateRegistryCheckWithProps.find('#person0outOfStateRegistry0true').hostNodes()
