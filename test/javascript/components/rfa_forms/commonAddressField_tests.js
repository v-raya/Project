...
describe('Verify Common Address Fields Component', () => {
  ...
  it('verify mailing address zip change', () => {
    ...
    expect(onChangeSpy).toHaveBeenCalledWith('zip', '95833', 0)
  })
  it('verify mailing Address city change', () => {
    ...
    expect(onChangeSpy).toHaveBeenCalledWith('city', 'Sacramento', 0)
  })
  it('verify mailing Address State change', () => {
    ...
    expect(onChangeSpy).toHaveBeenCalledWith('state', { id: 1, value: 'Alabama' }, 0)
  })
})