...
import line_off from './images/line_off.png';
import line_on from './images/line_on.png';
import grid_on from './images/grid_on.png';
import grid_off from './images/grid_off.png';
...
export default class SearchDetails extends React.Component {
  render() {
    ...
    let searchFacilityId = searchData[2];
    let searchFacilityName = searchData[3];
