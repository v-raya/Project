class Facility < CalsBase
  ...
  attr_accessor :visits, :annual_visit_year, :last_visit_reason, :last_visit_date, :email_address, :capacity, :capacity_last_changed, :original_application_recieved_date, :available_beds, :adjusted_capacity
